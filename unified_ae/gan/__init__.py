...
def build_discriminator(config: dict, device: torch.device) -> tuple[DinoDiscriminator, DiffAug]:
    """Instantiate the Dino-based discriminator together with its augmentation policy."""
