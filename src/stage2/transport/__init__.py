...
def create_transport(
    ...
    **Note**: model prediction defaults to velocity
    ...
    - learn_x_start: set model prediction to clean endpoint x1
    ...
    prediction_key = str(prediction).lower().replace("-", "_")
    if prediction_key == "noise":
        model_type = ModelType.NOISE
    elif prediction_key == "score":
        model_type = ModelType.SCORE
    elif prediction_key in {"x", "x1", "x_start", "xstart", "x_pred", "xpred"}:
        model_type = ModelType.X_START
    else:
