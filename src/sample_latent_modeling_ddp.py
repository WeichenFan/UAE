...
def main(args):
    ...
    uae_config, model_config, transport_config, sampler_config, guidance_config, misc, _, _ = parse_configs(cfg)
    ...
    for step_idx in pbar:
        with autocast(**autocast_kwargs):
            ...
            samples = uae.decode(latent_adapter.from_model_space(samples)).clamp(0, 1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--per-proc-batch-size", type=int, default=375)
